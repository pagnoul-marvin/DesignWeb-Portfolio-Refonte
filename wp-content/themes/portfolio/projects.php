    ...
    <div class="flex_container">
        ...
        <div class="list_links">
            ...
            <ul class="flex_container">
                ...
                <li><a class="cards_link" href="<?= get_field('projects_header_first_link')['url'] ?>"
                       title="Aller vers la page À propos"><?= get_field('projects_header_first_link')['title'] ?></a>
                </li>
                <li><a class="cards_link" href="<?= get_field('projects_header_second_link')['url'] ?>"
                       title="Aller vers la page Mes projets"><?= get_field('projects_header_second_link')['title'] ?></a>
                </li>
                <li><a class="cards_link" href="<?= get_field('projects_header_third_link')['url'] ?>"
